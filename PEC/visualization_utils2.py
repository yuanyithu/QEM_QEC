...
def plot_inverse_probability(L_list, L_check_list, p_matrix, save_path='inverse_probability.png'):
    """
    ...
    Args:
        ...
        p_matrix: shape (len(L_check_list), len(L_list))
...
def plot_pec_sample(L_list, L_check_list, pec_matrix, save_path='pec_sample.png'):
    """
    ...
    Args:
        L_list: array of L values (x-axis)
        L_check_list: array of L_check values (different curves)
        pec_matrix: shape (len(L_check_list), len(L_list))
        save_path: output file path
    """
    setup_nature_style()
    fig, ax = plt.subplots()
...
def plot_total_sample(L_list, L_check_list, total_matrix, save_path='total_sample.png'):
    """
    ...
    Args:
        L_list: array of L values (x-axis)
        L_check_list: array of L_check values (different curves)
        total_matrix: shape (len(L_check_list), len(L_list))
        save_path: output file path
    """
    setup_nature_style()
    fig, ax = plt.subplots()
...
def save_results_to_csv(L_list, L_check_list, p_matrix, pec_matrix, 
...
def plot_all(L_list, L_check_list, p_matrix, pec_matrix, total_matrix, prefix=''):
    """Convenience function to plot all three figures."""
    plot_inverse_probability(L_list, L_check_list, p_matrix, 
                            save_path=f'{prefix}inverse_probability.png')
    plot_pec_sample(L_list, L_check_list, pec_matrix, 
                   save_path=f'{prefix}pec_sample.png')
    plot_total_sample(L_list, L_check_list, total_matrix, 
